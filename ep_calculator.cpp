...
int main() {
	...
	while (true) {
		...
		cout << "Please paste the horse's personality and conformation text below and press enter." << endl;
		while (reading) {
			getline(cin, line);
		...
		cout << "\nConformation: " << extMin/10 << " - " << extMax/10 << endl;
		cout << "Personality: " << (round((intMin/7)*10))/10 << " - " << (round((intMax/7)*10))/10 << endl;
		cout << "\nEnter \"+\" to calculate another horse's grades.\n\n";
